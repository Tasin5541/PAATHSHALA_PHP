...
<head>
	...
	<link rel="stylesheet" href="assets/css/vid_upload.css">
</head>
			...
			<div class="form_middle">
				<div class="d-flex">
					<div class="form_left">
						<div class="center"> 
						<a>
							<img src="assets/images/video.gif" style="width:100%;">
						</a>
						</div>
					</div>
					<div class="flex-fill form_right">
						<div>
							<p class ="form_msg">Upload A Tutorial</p>
						</div>
						...
						<form action="" method="POST" enctype="multipart/form-data">
								...
								<div class="col-lg-6 ">
									<div class="form-group">
									  <label >Choose Topic : </label>
										<select name="vid_topic" class="form-control">
							...
							<div class="form-group">
								...
								<input type="text" id="vid_title" name="vid_title" class="form-control" placeholder="Enter Title" required/>
							</div>
							</div>
							</div>
							...
							<div class="form-group">
								<label>Video : </label>
								<input type="file" style="height:100px;" class="form-control" id="vid_brief" placeholder="Upload Video" name="file" required>				
							</div>
							
				
							<div class="row">
							<div class="col-lg-12 ">
								<button type="submit" name = "vid_submit" value = "submit" class="btn btn-success">Upload Video</button>
							</div>
							</div>
						  </form>
					</div>
