...
<head>
	...
	<link rel="stylesheet" href="assets/css/edit_qa.css">
</head>
						...
						<div class="card-header py-3">
							...
							<?php echo $msg; ?>
								...
								<div class="form-group">
									<input type="text" id="qa_title" name="qa_title" class="form-control" value="<?php echo $qa_title; ?>" required />
								</div>
								<div class="form-group">
									<textarea type="text" style="height:150px;" class="form-control" id="qa_brief" name="qa_brief" required><?php echo $qa_brief; ?></textarea>					
								</div>
								<button type="submit" name = "qa_update" value = "submit" class="btn btn-success">Update</button>
								<button type="submit" name = "qa_cancel" value = "submit" class="btn btn-success">Cancel</button>
