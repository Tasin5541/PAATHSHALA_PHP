		...
		<!--sidebar-->
			<div class="col-md-2 ">
				<nav class="main-menu shadow">
					...
					<?php } ?>
						...
						<li class="has-subnav">
							<a href=topic_qa.php?topic=PHYSICS><i class="fa fa-superpowers fa-2x"></i>
								<span class="nav-text">Physics</span>
							</a>
						</li>

						<li class="has-subnav">
							<a href=topic_qa.php?topic=CHEMISTRY><i class="fa fa-flask fa-2x"></i>
								<span class="nav-text">Chemistry</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=MATH><i class="fa fa-calculator fa-2x"></i>
								<span class="nav-text">Math</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=BIOLOGY><i class="fa fa-heartbeat fa-2x"></i>
								<span class="nav-text">Biology</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=BENGALI><i class="fa fa-language fa-2x"></i>
								<span class="nav-text">Bengali</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=ENGLISH><i class="fa fa-info fa-2x"></i>
								<span class="nav-text">English</span>
							</a>
						</li>
						<li class="has-subnav">
							<a href=topic_qa.php?topic=ICT><i class="fa fa-code fa-2x"></i>
								<span class="nav-text">ICT</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=CSE><i class="fa fa-laptop fa-2x"></i>
								<span class="nav-text">CSE</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=EEE><i class="fa fa-bolt fa-2x"></i>
								<span class="nav-text">EEE</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=CE><i class="fa fa-building-o fa-2x"></i>
								<span class="nav-text">CE</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=ARCHITECTURE><i class="fa fa-university fa-2x"></i>
								<span class="nav-text">Architecture</span>
							</a>
						</li>
						
						<li class="has-subnav">
							<a href=topic_qa.php?topic=MPE><i class="fa fa-industry fa-2x"></i>
								<span class="nav-text">MPE</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=ME><i class="fa fa-cogs fa-2x"></i>
								<span class="nav-text">ME</span>
							</a>
						</li>

						<li>
							<a href=topic_qa.php?topic=OTHER><i class="fa fa-table fa-2x"></i>
			...
			<div class="col-md-7">
				...
				<?php while($qa_row = mysqli_fetch_row($qa_result)){ 
					...
					$qa_com_sql = "SELECT * FROM comments WHERE post_id=$qa_id";
					$qa_com_result = mysqli_query($qa_link,$qa_com_sql) or die(mysqli_error($qa_link));

					$noOfCom = mysqli_num_rows($qa_com_result);
				?>
						...
						<div class="text-post">
							...
							<div class="card-body">
								<div class="heading">
										...
										<a href=view_account.php?u_id=<?php echo $qa_u_id; ?>>
