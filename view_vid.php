						...
						<div class="text-post">
							...
							<div class="p-footer">
								<div class="row">
									...
									<div class="col-md-5">
										<a href=view_post.php?vid_id=<?php echo $vid_id; ?>><button class="trans"><span><i class="fa fa-comment"></i></span>
										comment</button></a>
									</div>
				...
				<div class="comment shadow">
					<div class="c-mid">
						...
						<div class="c_section" id="all_comments">
							...
							$sql = "SELECT comment_id, comment,username FROM video_comment where parent_comment_id = 0 and video_id = '$vid_id' order by comment_id desc";
								...
								<div class="col-md-9 ">
									...
									<!--ekhane kaj-->
										...
										<div class="row" id="all_reply">
											...
											$rp_sql = "SELECT comment_id, comment,username FROM video_comment where  parent_comment_id= '$comment_id' order by comment_id desc";
