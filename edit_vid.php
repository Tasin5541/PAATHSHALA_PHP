...
<head>
	...
	<link rel="stylesheet" href="assets/css/edit_vid.css">
</head>
		...
		<div class="container">
			<div class="form_middle">
				...
				?>
					...
					<div class="mid-post no_scroll effect6">
						<div class="text-post">
						<div class="post-top">
								<button class="posts">TUTORIAL </button>
								<button class="posts"><?php echo $vid_topic; ?> </button>
							</div>
							...
							<?php echo $msg; ?>
								<div class="heading">
										...
										<span><?php echo $vid_username; ?></span>
								...
								<div class="form-group">
									<input type="text" id="vid_title" name="vid_title" class="form-control" value="<?php echo $vid_title; ?>" required />
								</div>
								...
								<button type="submit" name = "vid_update" value = "submit" class="btn btn-success">Update</button>
								<button type="submit" name = "vid_cancel" value = "submit" class="btn btn-success">Cancel</button>
