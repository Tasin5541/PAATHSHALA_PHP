			...
			<div class="form_middle">
				<div class="d-flex">
					<div class="form_left">
						<div class="center"> 
						<a>
							<img src="assets/images/qa3.webp" style="width:100%;">
						</a>
						</div>
					</div>
					<div class="flex-fill form_right">
						<div>
							<p class ="form_msg">Ask a Question</p>
						</div>
						...
						<form action="" method="POST" enctype="multipart/form-data">
								...
								<div class="col-lg-6 ">
									<div class="form-group">
									  <label >Choose Topic : </label>
										<select name="qa_topic" class="form-control">
							...
							<div class="form-group">
								...
								<input type="text" id="qa_title" name="qa_title" class="form-control" placeholder="Enter Title" required />
							</div>
							</div>
							</div>
							...
							<div class="form-group">
								<label>Brief : </label>
								<textarea type="text" style="height:150px;" class="form-control" id="qa_brief" placeholder="Describe Briefly" name="qa_brief" required></textarea>					
							</div>
							
				
							<div class="row">
							<div class="col-lg-12 ">
								<button type="submit" name = "qa_submit" value = "submit" class="btn btn-success">Submit Question</button>
							</div>
							</div>
						  </form>
					</div>
