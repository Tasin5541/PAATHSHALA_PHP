							...
							<div class="p-footer">
								<div class="row">
									<div class="col-md-2" style="margin-left:3%;">
										<button class="trans"><span><i class="fa fa-chevron-up"></i></span></button>
										<a>9999</a>
										<button class="trans"><i class="fa fa-chevron-down"></i></span></button>
									</div>
									<div class="col-md-5">
									...
									<?php if ((isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) 
										...
										<div class="col-md-3 edit_dlt ml-auto">
											<a href=vid_edit.php?vid_id=<?php echo $vid_id; ?>><button class="trans"><span><i class="fa fa-pencil-square-o"></i></span>
											</button></a>
